...
export const CURATED_ETYMOLOGIES: EtymologyFact[] = [
    ...
    { word: 'robot', fact: 'Czech writer Karel Capek invented this word in 1920 from "robota" meaning "forced labor."', minLevel: 1 },
    ...
    { word: 'calculate', fact: 'From Latin "calculus" meaning "small stone." Romans used pebbles on counting boards to do math!', minLevel: 4 },
